...
public class EnrollListAdapter extends ArrayAdapter<Enrollment> {
    ...
    public EnrollListAdapter(Context context, int resource, ArrayList<Enrollment> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView sbcode = (TextView) convertView.findViewById(R.id.subcode);
        TextView sbname = (TextView) convertView.findViewById(R.id.subname);
